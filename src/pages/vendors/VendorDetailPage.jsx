...
import { getVendorDetail, updateVendor, deleteVendor } from '../../store/slices/vendorSlice'
...
export default function VendorDetailPage() {
  ...
  const { detail: vendor, loading, error } = useSelector(state => state.vendor)
  ...
  const handleSaveEdit = async () => {
    try {
      await dispatch(updateVendor({ id, ...editData })).unwrap()
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="bg-background border border-border rounded-lg p-6 h-fit space-y-4">
          <h3 className="font-semibold text-lg">Vendor Stats</h3>
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-muted-foreground">Total Purchases</span>
              <span className="font-medium">${vendor.totalSpent || 0}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Outstanding Balance</span>
              <span className="font-medium text-orange-600">${vendor.outstandingBalance || 0}</span>
            </div>
